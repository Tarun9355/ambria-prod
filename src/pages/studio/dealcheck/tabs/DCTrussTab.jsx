                            ...
                            return (
                              <div key={zk + "-" + rowIdx} style={{padding:"12px 14px",borderRadius:9,background:isInvalid?"rgba(239,68,68,0.04)":"rgba(99,102,241,0.04)",border:`1px solid ${isInvalid?"rgba(239,68,68,0.30)":border}`}}>
                                ...
                                {isInvalid && pv.warnings?.length > 0 && (
                                  <div style={{fontSize:13,color:"#FCA5A5",padding:"6px 10px",background:"rgba(239,68,68,0.08)",borderRadius:6}}>
                                  ...
                                  <>
                                    ...
                                    {(() => {
                                      ...
                                      const FabricRow = ({ emoji, label, qty, unitLabel, allocs, totals, fabricType, allocField, breakdown }) => {
                                        ...
                                        return (
                                          <div style={{padding:"6px 10px",background:hasShort?"rgba(245,158,11,0.07)":"rgba(26, 26, 46,0.02)",border:`1px solid ${hasShort?"rgba(245,158,11,0.25)":"rgba(26, 26, 46,0.05)"}`,borderRadius:6,marginBottom:5}}>
                          ...
                          return (
                            <div style={{padding:"7px 12px",background:"rgba(26, 26, 46,0.03)",borderRadius:6,marginBottom:5,display:"flex",justifyContent:"space-between",alignItems:"center",gap:10,flexWrap:"wrap"}}>
                              ...
                              {data.shortQty > 0 ? (
                                ...
                                <span style={{fontSize:12,color:"#10B981",whiteSpace:"nowrap"}}>{fmtRs(data.rentalTotal)} · ✓ in stock</span>
                              )}
                            </div>
                          );
                        };
                        ...
                        return (
                          <div style={{marginTop:2,padding:"11px 14px",borderRadius:9,background:"rgba(99,102,241,0.08)",border:"1px solid rgba(99,102,241,0.35)"}}>
                            ...
                            <div style={{display:"flex",gap:8,flexWrap:"wrap"}}>
                              ...
                              <Card label="🪡 Fabric" value={fabricC} accentColour="#4338CA" />
