...
export default function AdminTab({ users, setUsers, vendors, setVendors, functions, settings, setSettings, supervisors, setSupervisors, studio, inventory, trussInv }) {
